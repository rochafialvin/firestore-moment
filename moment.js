...
m = moment().add(3, "d").add(1, "M");
// June 5, 2021 10:09 PM
m = moment().add({ days: 3, months: 1 });
// June 5, 2021 10:09 PM
m = moment().add({ d: 3, M: 1 });

// May 2, 2021 10:19 PM
m = moment();
// April 29, 2021 10:20 PM
m = moment().subtract(3, "days");
// March 29, 2021 10:20 PM
m = moment().subtract(3, "d").subtract(1, "M");
// March 30, 2021 10:20 PM
m = moment().subtract({ days: 3, months: 1 });
// March 30, 2021 10:20 PM
m = moment().subtract({ d: 3, M: 1 });
